...
//public struct Keeper { // : QueryServer {
//	let storeKey: StoreKey
//	let codec: BinaryMarshaler
//	let clientKeeper: types.ClientKeeper
//	let connectionKeeper: types.ConnectionKeeper
//	let portKeeper: types.PortKeeper
//	let scopedKeeper: capabilitykeeper.ScopedKeeper
//}
